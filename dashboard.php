					...
					<tr>
						...
						<td>
							<div class="media">
								...
								<div class="media-body">
									<a href="<?=path?>/tree.php?id=<?=$rs['id']?>&t=<?=fh_seoURL($rs['name'])?>"><?=$rs['name']?></a>
								</div>
							</div>
						</td>
						...
						<td class="pt-options">
							...
							<ul class="pt-drop">
								<li><a href="<?=path?>/tree.php?id=<?=$rs['id']?>&t=<?=fh_seoURL($rs['name'])?>"><i class="far fa-edit"></i> <?=$lang['dashboard']['edit']?></a></li>
...
<div class="p-4 pt-0">
  ...
  <div class="tab-content">
				...
				<div class="row">
					...
					<div class="col">
						<div class="pt-box m-0 mt-5">
							...
							<div class="float-right"><a href="#" class="pt-delete btn btn-danger btn-sm m-2" data-id="<?=$rs2['id']?>" data-request="languages"><i class="fas fa-trash-alt"></i> <?=$lang['dashboard']['delete']?></a></div>
						</div>
					</div>
				</div>
				<ul class="nav nav-tabs">
		...
		<table class="table">
			...
			<tbody>
				...
				<tr>
					<td>
						<span></span>
						<a href="<?=path?>/page.php?id=<?=$rs['id']?>"><?=$rs['title']?></a>
					</td>
					<td>
	...
	<table class="table">
			...
			<div class="pt-body">
				...
				<div class="pt-admin-setting">
					...
					<div class="form-group">
						...
						<textarea name="site_ads1"><?=site_ads1?></textarea>
					</div>
		...
		<div class="pt-footer">
			<div>
					Copyright © 2020 <a href="#"><?=site_title?></a>. All Rights Reserved.<br>
			</div>
		</div>
	</div>
</div>
