...
<div class="pt-tree">
	<div class="pt-details">
		<?php if($lg == $rs['author'] || (us_id && in_array(us_name, explode(',', $rs['moderators'])))): ?>
			...
			<a href="#" data-name="<?=fh_seoURL($rs['name'])?>" class="pdf-download"><i class="fas fa-link"></i> <?=$lang['treepage']['pdf']?></a>
			<?php endif; ?>
			<?php endif; ?>
		...
		<?php endif; ?>
		<?php endif; ?>
	<div class="pl-share" style="color:blue;text-align:center;margin-right: 10px;">
	<input type="text" name="search" placeholder="<?=$lang['header']['search1']?>" />
		<button type="submit"><i class="fas fa-search"></i></button>
		<div class="sresults1"></div>
  	</div>	
	<div class="pl-share">
