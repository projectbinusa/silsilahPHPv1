...
my $projectroot = '/home/dinartechshare-e/domains/silsilah.dinartechshare-e.com/public_html/git';
...
my $snapshots_url = 'http://silsilah.dinartechshare-e.com/git';
my $git_base_url = 'http://silsilah.dinartechshare-e.com/git';
